...
\input{pre_textuals/cataloging.tex}

\input{pre_textuals/approval.tex}

\newpage

%-----------------------------------
% Dedication 
\include{pre_textuals/dedication}

%-----------------------------------
% Acknowledgments
\include{pre_textuals/acknowledgments}

%-----------------------------------
% Epigraph
\include{pre_textuals/epigraph}

%-----------------------------------
% Resumo (abstract in Portuguese)
%\setlength{\absparsep}{18pt} % set spacing between the paragraphs

\include{pre_textuals/abstract}

%-----------------------------------
% Preface
\include{pre_textuals/preface}
...
%-----------------------------------
% Abbreviations
\input{pre_textuals/acronyms.tex}
\cleardoublepage

%-----------------------------------
% Symbols
\input{pre_textuals/symbols.tex}
\cleardoublepage
...
%-----------------------------------
% Chapters
\include{chapters/chp1_introduction}
\include{chapters/chp2_review_fts}
\include{chapters/chp3_review_prob}
\include{chapters/chp4_pwfts}
\include{chapters/chp5_hyperparamopt}
\include{chapters/chp6_granular}
\include{chapters/chp7_conclusion}
...
% Attachments
%\include{post_textuals/attachments}

% Appendix
\include{post_textuals/appendix}
